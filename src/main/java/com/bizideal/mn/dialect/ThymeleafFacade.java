...
/**
 * @author 作者 liulq:
 * @data 创建时间：2017年3月10日 下午5:49:37
 * @version 1.0
 */
public final class ThymeleafFacade {
	...
	public static String getRawValue(final IProcessableElementTag element,
	...
	public static Object evaluateExpression(ITemplateContext arguments,
			String expression) throws TemplateProcessingException {
	...
	public static List<Object> evaluateAsIterable(ITemplateContext arguments,
			String rawValue) throws TemplateProcessingException {
		notNull(arguments, "arguments must not be null");
		notEmpty(rawValue, "rawValue must not be empty");

		final Object evaluatedExpression = evaluateExpression(arguments,
				rawValue);
	...
	public static List<String> evaluateAsStringsWithDelimiter(
		...
		final List<Object> iterates = evaluateAsIterableOrRawValue(arguments,
				rawValue);
